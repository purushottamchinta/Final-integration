...
import CardComponent from '../favoriteCard/Favoritecard'
...
class Favorite extends Component {
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:8091/NewsSourceService/api/v1/newssource/",{ headers: { "Authorization": "Bearer " + localStorage.getItem("token") } }
        )
