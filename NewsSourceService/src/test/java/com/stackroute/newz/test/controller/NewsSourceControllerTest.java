...
public class NewsSourceControllerTest {
    ...
    public void deleteNewssourceSuccess() throws Exception {
        ...
        when(newssourceService.deleteNewsSource("test","1")).thenReturn(true);
    ...
    public void deleteNewssourceFailure() throws Exception {
        ...
        when(newssourceService.deleteNewsSource("test","1")).thenReturn(false);
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/newssource/1")
                .contentType(MediaType.APPLICATION_JSON)).andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void deleteAllNewsSuccess() throws Exception {
        ...
        when(newssourceService.deleteAllNewsSource("1")).thenReturn(true);
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/newssource/1")
                .contentType(MediaType.APPLICATION_JSON)).andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void deleteAllNewsFailure() throws Exception {
        ...
        when(newssourceService.deleteAllNewsSource("1")).thenReturn(false);
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/newssource/1")
                .contentType(MediaType.APPLICATION_JSON)).andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void getNewssourceByIdFailure() throws Exception {
    	String newssourceId = newsSource.getNewsSourceId();
